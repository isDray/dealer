...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="header">
            <h2>
            {{$title}}表格
            <small>填寫以下表格以編輯公告</small>
            </h2>
        </div>

        <div class="body">
        
            <form action="{{url('/announcementEditDo')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class='col-sm-12'>
                    <div class="row clearfix">
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control myborder" name="name" placeholder="" value="{{$announcement['name']}}"/>
                            </div>
                            </div>
                        </div>
                    </div>
...
<!--                     <div class="row clearfix">
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control myborder" name="sort" placeholder="" value="{{$announcement['sort']}}" />
                            </div>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <div class="row clearfix">
                       <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="demo-checkbox">
                                ...
                                <textarea id="ckeditor" name='content'>{{$announcement['content']}}</textarea>
