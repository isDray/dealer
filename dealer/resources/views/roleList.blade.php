    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger waves-effect roleDelete" rid="{{$role->id}}" rname="{{$role->display_name}}">
                ...
                <form action="{{url('/roleDeleteDo')}}" method="POST" id='deleteForm'>
                    {{ csrf_field() }}
...
$(function(){
    ...
    $('body').on('click', '.roleDelete', function() {
        ...
        Swal.fire({
            title: '刪除確認',
            text: "即將刪除身分:"+$(this).attr('rname')+",確定要刪除?",
            type: 'warning',
